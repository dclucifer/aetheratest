...
function pathSafeConsoleLogTranslations() {
    ...
    try {
        console.log('Language:', localStorage.getItem('direktiva_language') || localStorage.getItem('aethera_language') || 'id');
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    applyTheme(localStorage.getItem('direktiva_theme') || localStorage.getItem('aethera_theme') || 'dark');
    // Apply language after translations are loaded
    const savedLanguage = localStorage.getItem('direktiva_language') || localStorage.getItem('aethera_language') || 'id';
    ...
    const initialTheme = localStorage.getItem('direktiva_theme') || localStorage.getItem('aethera_theme') || 'dark';
